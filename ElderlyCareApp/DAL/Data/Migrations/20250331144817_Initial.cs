        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Preferences = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    GuardianIdCard = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HealthConditions = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElderlyProfiles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElderlyProfileId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    DeletedBy = table.Column<int>(type: "int", nullable: true),
                    LastModifiedBy = table.Column<int>(type: "int", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_ElderlyProfiles_ElderlyProfileId",
                        column: x => x.ElderlyProfileId,
                        principalTable: "ElderlyProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    RecoredDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BloodPresure = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_ElderlyProfileId",
                table: "Users",
                column: "ElderlyProfileId");
        }
